    ...
    <div className="flex flex-col w-full max-w-[1600px] mx-auto pb-10">
      <div className="flex items-center justify-between">
        <div className="flex flex-col gap-1">
          <h2 className="text-3xl font-bold tracking-tight text-gray-900">Pembelian</h2>
          <p className="text-muted-foreground text-sm">Catat dan kelola transaksi pembelian dari supplier.</p>
        </div>
      ...
      <div className="mt-6 flex flex-col items-center justify-center p-12 border rounded-xl bg-gray-50/50 border-dashed">
        ...
        <p className="text-muted-foreground text-sm max-w-sm text-center mt-1">Backend API untuk modul pembelian belum diimplementasikan. Halaman ini masih dalam tahap konstruksi.</p>
      </div>
    </div>
  )
}
