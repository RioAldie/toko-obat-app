    ...
    <div className="flex flex-col w-full max-w-[1600px] mx-auto pb-10">
      <div className="flex items-center justify-between">
        <div className="flex flex-col gap-1">
          <h2 className="text-3xl font-bold tracking-tight text-gray-900">Merek</h2>
          <p className="text-muted-foreground text-sm">Kelola merek produk yang dijual di toko Anda.</p>
        </div>
        <Button className="bg-primary text-white hover:bg-primary/90 rounded-lg shadow-sm">
          <Plus className="mr-2 h-4 w-4" /> Tambah Merek
        </Button>
      </div>
      ...
      <div className="mt-6 flex flex-col items-center justify-center p-12 border rounded-xl bg-gray-50/50 border-dashed">
        ...
        <p className="text-muted-foreground text-sm max-w-sm text-center mt-1">Backend API untuk modul merek belum diimplementasikan. Halaman ini masih dalam tahap konstruksi.</p>
      </div>
    </div>
  )
}
